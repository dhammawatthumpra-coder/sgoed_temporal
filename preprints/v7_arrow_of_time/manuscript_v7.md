...
Seeds: $\{42,\dots,53\}$ (≥10 for fine grids; ≥6 elsewhere, as reported). Detailed reproducibility notes and the full results chain (updates 1–17) in `notes/SGOED_TIME_EMERGENCE_SUMMARY.md`; project context in `notes/SGOED_PROJECT_SUMMARY.md`.
