...
- Local provenance search was performed across `F:\_Ai\sgoed\V5` and the wider `F:\_Ai\sgoed` tree for executable definitions of `A_init`, `area_excess`, and `decay_len`.
